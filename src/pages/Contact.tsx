          ...
          <div>
            ...
            <div className="buttons my-1">
              <a href="mailto: f20200611@pilani.bits-pilani.ac.in">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">Email</button>
              </a>
              <a href="https://www.instagram.com/_neeyl/">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">Instagram</button>
              </a>
              <a href="https://github.com/subhramit">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">GitHub</button>
              </a>
              <a href="https://www.linkedin.com/in/subhramit-basu/">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">LinkedIn</button>
              </a>
              <a href="https://www.facebook.com/subhramit.basu/">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">Facebook</button>
              </a>
              <a href="https://www.quora.com/profile/Subhramit-Basu/">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">Quora</button>
              </a>
              <p className="py-3 md:w-1/2 pl-1 font-serif pt-4">
                Send me an anonymous message:
              </p>
              <a href="https://www.confessout.com/neeyl">
                <button className="bg-uno px-3 py-2 rounded-xl text-white hover:text-white hover:bg-tres mx-2 my-1">Confessout</button>
              </a>
            </div>
          </div>
        </div>
