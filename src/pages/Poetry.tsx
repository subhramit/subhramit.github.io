...
export default function Poetry() {
  return (
    <div className="max-w-8xl mx-auto px-4 py-8">
      ...
      <div
        className="text-4xl md:text-5xl text-center md:text-start font-serif font-extralight md:pl-[15rem] pt-7 underline decoration-2">
        My thoughts on poetry
      </div>

      <div
        className="text-[17px] sm:text-lg md:text-xl text-start font-serif font-medium md:pl-[15.5rem] md:pr-[15.5rem] pt-4 italic">
      ...
      <div
        className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-[15.5rem] pt-4 md:pr-[15.5rem]">
        <p>When it comes to poetry, I have never believed in constrained definitions about words on a page. I have
          always felt poets are not just the ones who write poetry, but also the ones who just possess a poetic mind - a
          mind that is capable of appreciating poetry or anything that is poetic. And here births the paradox - as all
          poetry is created by the poets, so that means all that is considered poetic is also only made so by the poets
          themselves. <br />
          <br />
          I always imagined an ideal "poets society" to be one in which people can, without any obligation to do so,
          come and sit together during a random sunset, look at the sky and just drown in the moment. Perhaps this is
          why I never made it to my college's poetry club.
          <br />
          I don't write poems often, nor do I know if I'll ever write again, but here are some words that I put together
          during different occassions and needless to say, in different states of mind.
        </p>
      </div>

      <div
        className="text-2xl sm:text-3xl md:text-4xl text-start font-serif font-extralight md:pl-[15rem] pt-6">Madness
      </div>
      ...
      <div
        className="text-2xl sm:text-3xl md:text-4xl text-start font-serif font-extralight md:pl-[15rem] pt-6">Storms
      </div>
      <div className="text-base md:text-lg text-start font-serif font-medium md:pl-[15.18rem] pt-2 italic">
