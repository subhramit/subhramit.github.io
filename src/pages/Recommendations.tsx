...
export default function Recommendations() {
    return (
        <div className="max-w-8xl mx-auto px-4 py-8">
            <div className="text-4xl md:text-6xl text-center font-serif font-extralight underline decoration-2 pt-7">Recommendations</div>
            ...
            <div className="text-2xl md:text-3xl text-start font-serif font-bold md:pl-60 pt-5 underline">Stand-up comics</div>

            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-extralight md:pl-60 md:pr-72 pt-5 italic">
                <p>"Dear Sad, look on the bright side. Being ghosted by your crush is far superior to being crushed by a ghost."</p>
            </div>
            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-extralight md:pl-60 md:pr-72">
                <p>-Kanan Gill, April 2020</p>
            </div>

            <div className="text-xl md:text-2xl text-start font-serif font-medium md:pl-60 pt-2">Indian:</div>
            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 md:pr-60">
                <p>
            ...
            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-60">
                <p>
            ...
            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-8 md:pr-60">
                <p>
            ...
            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-72">
                <p>
            ...
            <div className="text-2xl md:text-3xl text-start font-serif font-bold md:pl-60 pt-6 underline">Disney/DreamWorks Movies</div>
            ...
            <div
                className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-6 md:pr-60">
                <p>
            ...
            {/* Series Section */}
            <div className="text-2xl md:text-3xl text-start font-serif font-bold md:pl-60 pt-6 underline">Series</div>

            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-2 md:pr-60">
                <p>
            ...
            <div
                className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-72">
                <p>
            ...
            <div className="text-2xl md:text-3xl text-start font-serif font-bold md:pl-60 pt-6 underline">Books/Stories</div>
            ...
            {/* Podcasts Section */}
            <div className="text-2xl md:text-3xl text-start font-serif font-bold md:pl-60 pt-6 underline">Podcasts</div>
            ...
            <div className="text-base sm:text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-72 pb-6">
                <p>
