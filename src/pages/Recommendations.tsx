    ...
    return (
        <div className="max-w-8xl mx-auto px-4 py-8">
            ...
            <div className="text-base sm:text-[17px] md:text-lg lg:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-72">
                ...
                <br />
                <p>
                    The Bhagavad Gita is a very old scripture which (objectively) consists of a conversation between two friends, Arjuna and Krishna. Arjuna finds himself in a war in which he has to fight for Dharma, against his own kin, and consequently finds himself trembling (both physically and metaphorically) and is unable to wield his bow against them. He turns to Krishna for guidance, which leads to a discourse between them involving many questions and answers. This guides Arjuna through the battle, out of which he emerges victorious, despite having an army which would otherwise be considered weaker than his opponent's (Duryodhan). It is a very deep piece of literature and when unpacked properly, acts as a guide to life in general. You can find every piece of important, fundamental wisdom you can ever gather from any elder, ted talk, book, etc. contained within the umbrella of some verse within some chapter of this book, but only if understood properly, as time and again it has also been subject to a lot of misinterpretations.<br /><br />
