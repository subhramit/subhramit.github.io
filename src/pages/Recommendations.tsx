...
export default function Recommendations() {
    return (
        <div className="max-w-8xl mx-auto px-4 py-8">
            ...
            <div className="text-lg md:text-xl text-start font-serif md:pl-[245px]">
            ...
            <div
                className="text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-60">
                <p>Here's
                    a <a
                        href="https://www.youtube.com/watch?v=YDDlFHQ1Vgw&t=468s&ab_channel=SrijanKaushik"
                        className="hover:text-tres text-pink-600">link</a> to
                    a
                    short
                    stand-up
                    clip
                    ...
                    Kaushik. <br/>
                    Here's <a
                        href="https://www.youtube.com/watch?v=6CdhE3hh2CQ&ab_channel=SumitAnand"
                        className="hover:text-tres text-pink-600">one</a> by
                    Sumit
                    Anand. <br/>
                    I'm
                    not
                    ...
                    people. <br/>
                    Here's <a
                        href="https://www.youtube.com/watch?v=n9Cql4qMrQ8&ab_channel=DanielFernandes"
                        className="hover:text-tres text-pink-600">one</a> by
                    Daniel
                    Fernandes
                    (you
                    ...
                    of
                    KV <a
                        href="https://www.youtube.com/watch?v=kcKQI0J6pmU&ab_channel=RandomChikibum"
                        className="hover:text-tres text-pink-600">here</a> (I
                    don't
                    know
                    why,
                    but
            ...
            <div
                className="text-lg md:text-xl text-start font-serif font-extralight md:pl-60 md:pr-72 pt-5 italic">
                <p>"We
                    wear
                    our
                    scarves
            ...
            <div
                className="text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-72">
                <p>I
                    remember
                    reading
                    about
            ...
            <div
                className="text-2xl md:text-3xl text-start font-serif font-bold md:pl-60 pt-6 underline">
                Disney/DreamWorks
                Movies
            </div>
            ...
            <div
                className="text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-6 md:pr-60">
                <p>
                    <strong>1.
                        Brave</strong><br/>
                    <strong>2.
            ...
            <div
                className="text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-2 md:pr-60">
                <p>
                    <strong>1.
                        BoJack
                        Horseman</strong><br/>
            ...
            <div className="text-lg md:text-xl text-start font-serif font-extralight md:pl-60 md:pr-72 pt-5 italic">
                <p>"That's the problem with life, right? Either you know what you want, and then you don't get what you want, or you get what you want, and then you don't know what you want."
                </p>
            </div>
            ...
            <div
                className="text-lg md:text-xl text-start font-serif font-medium md:pl-60 pt-4 md:pr-72 pb-6">
                <p>'You
                    Started
                    it'
                    is
