        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="mb-12">
                ...
                <p className="mt-6 font-serif">
                    ...
                    My plan back then was that from time to time, I would be introducing more of the characters with the stories I share. Although most of the characters I mentioned here in the initial "list" still hold the same place in my life, as time passed, I came to the realization that it didn't make sense to have a such a list at all, as although many of those experiences involved people, it made more sense to focus on the experiences themselves than the people, apart from the fact that you "never know what happens tomorrow". <br/>
