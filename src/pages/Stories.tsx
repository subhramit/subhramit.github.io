    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <p className="mt-6 font-serif">
          Once upon a time, this section used to contain the names of people who either greatly influenced or played a
          significant part in the story of my life. It was (and is) difficult to make such a list, as there many people
          including my childhood friends, college friends and office co-workers who have come and stayed close to my
          heart as life unfolded, so I decided to start out small and only list a couple of people. <br />
          My plan back then was that from time to time, I would be introducing more of the characters with the stories I
          share. Although most of the characters I mentioned here in the initial "list" still hold the same place in my
          life, as time passed, I came to the realization that it didn't make sense to have a such a list at all, as
          even though many of those experiences involved people, it made more sense to focus on the experiences
          themselves rather than the people, apart from the fact that you "never know what happens tomorrow". <br />
          ...
          <article key={post.title} className="mb-12">
            ...
            {post.endQuote && (
              <div className="mt-6 mb-4">
                ...
                <cite className="block text-[16.67px] font-serif not-italic">-{post.endQuote.author}</cite>
              </div>
            )}
