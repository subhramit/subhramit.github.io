...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    And of course, two years ago, somewhere around this month, I confessed to the girl who ended up being the person to ruin a lot of my conceptions about how I was to "hope" to be "understood" for the rest of my life.
  ...
  },
  {
    ...
    date: '12.12.2025',
    content: `I was feeling really nostalgic today. Trying to trace back through some years of my childhood, I came across a very old email that my uncle had written to me as a reply to mine (in which I had wished him a happy new year), saying that he is proud that I have started sending emails.
  ...
  },
  {
    ...
    I don't think "moving on" in its truest sense is ever possible. Everyone who comes into our lives changes us in ways we don't even get to notice. Even after they are gone, we carry pieces of them with us.
  ...
  },
  {
    ...
    I really wanted to be someone who is able to have more "immersion".
    I was struggling to conceptualize it, but what I knew was that it had to do with how the sense or awareness of "you" dissolves when you are witnessing something way too captivating or beautiful. 
  ...
  },
  {
    ...
    I don't have words to describe how beautiful it is. Go watch it yourself if you've come this far in my blog.
    `,
  },
  {
    title: 'Solo Dates - II',
    ...
    After the concert, since I had traveled that far near Sarjapur, I decided to travel a bit more and go to Street 1522 - the place which serves "Indian Affair" - my favourite drink (think "South Peru", but Pineapple instead of Guavva). I had kicked a traffic cone out along the way when riding my bike-taxi, because I had to keep my leg straight with the braces. But it was all worth it.
  ...
  },
  {
    ...
    What's even better is that rains are here. It took its time this year, but Bangalore doesn't disappoint. I learned recently that humans can smell rains better than sharks can smell blood. Isn't that amazing?
